...
<body>
      <!--Prelouder-->
<style type="text/css">#hellopreloader>p{display:none;}#hellopreloader_preload{display: block;position: fixed;z-index: 99999;top: 0;left: 0;width: 100%;height: 100%;min-width: 1000px;background: #674172 url(http://hello-site.ru//main/images/preloads/bars.svg) center center no-repeat;background-size:86px;}</style>
<div id="hellopreloader"><div id="hellopreloader_preload"></div><p><a href="http://hello-site.ru">Hello-Site.ru. Бесплатный конструктор сайтов.</a></p></div>
<script type="text/javascript">var hellopreloader = document.getElementById("hellopreloader_preload");function fadeOutnojquery(el){el.style.opacity = 1;var interhellopreloader = setInterval(function(){el.style.opacity = el.style.opacity - 0.05;if (el.style.opacity <=0.05){ clearInterval(interhellopreloader);hellopreloader.style.display = "none";}},16);}window.onload = function(){setTimeout(function(){fadeOutnojquery(hellopreloader);},2500);};</script>
    <!--End Prelouder-->
...
<g id="close-icon">
    ...
    <div id="js-show-modal" class="launch-button">Регистрация
      <div class="launch-button__glare"></div>
    </div>
    <div id="js-show-modal" class="launch-button p">Вход через вк
      <div class="launch-button__glare"></div>
    </div>
    
    <div id="js-modal-overlay" class="modal-overlay"></div>
    <div id="js-modal-holder" class="modal-holder">
      <div id="js-hint1" class="hint hint--1">Авторизируйся через вк</div>
      <div id="js-hint2" class="hint hint--2">и добавляй<br> свое музло через вк</div>
      ...
      <form1 action="" id="js-modal" class="modal">
        ...
        <div class="modal__header">Регестрироваться
        </div>
        
        <div class="modal__section">
            <div class="input-with-label">
              <input id="name" type="text" class="input-with-label__input">
              <label for="name" class="input-with-label__label">Почта
        ...
        <div class="modal__section">
            <div class="input-with-label">
              ...
              <label for="password" class="input-with-label__label">Пароль
                <div class="input-with-label__label__corner"></div>
              </label>
            </div>
        </div>
...
<script src='https://cdnjs.cloudflare.com/ajax/libs/html2canvas/0.4.1/html2canvas.js'></script><script  src="./script.js"></script>
